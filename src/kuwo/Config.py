...
# print ("SNAP: " + SNAP)
path = SNAP + "/share/kwplayer/icons/"

# ICON_PATH = os.path.join(PREF, NAME, 'icons')
ICON_PATH = SNAP + "/share/kwplayer/icons"

# print("ICON_PATH: " + ICON_PATH) 

LRC_BACKGROUND_IMG = os.path.join(path, 'lrc-background.jpg')

# ANONYMOUS_IMG = os.path.join(ICON_PATH, 'anonymous.png')

ANONYMOUS_IMG = os.path.join(path, 'anonymous.png')
# print("ANONYMOUS_IMG: " + ANONYMOUS_IMG)

ANONYMOUS_PIXBUF = GdkPixbuf.Pixbuf.new_from_file(ANONYMOUS_IMG)

# HOME_DIR = os.path.expanduser('~')

HOME_DIR = os.environ['SNAP_USER_COMMON']
